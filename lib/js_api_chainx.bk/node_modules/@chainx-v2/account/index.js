...
(function (NET_PREFIX) {
  NET_PREFIX[NET_PREFIX["testnet"] = 42] = "testnet";
  NET_PREFIX[NET_PREFIX["mainnet"] = 44] = "mainnet";
})(NET_PREFIX || (exports.NET_PREFIX = NET_PREFIX = {}));
...
class Account {
  ...
  static fromSeed(seedLike) {
    const seedU8a = (0, _u8aFrom.default)(seedLike, 'hex');
  ...
  static generate() {
    const random = (0, _utilCrypto.randomAsU8a)(32);
    return new Account((0, _utilCrypto.naclKeypairFromSeed)(random));
  }
  /**
    * @name newMnemonic
