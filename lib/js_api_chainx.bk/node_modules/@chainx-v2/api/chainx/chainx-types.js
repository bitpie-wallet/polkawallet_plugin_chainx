...
var _default = {
  ...
  "AssetType": {
    "_enum": ["Usable", "Locked", "Reserved", "ReservedWithdrawal", "ReservedDexSpot"]
  },
  "OrderType": {
    "_enum": ["Limit", "Market"]
  },
  ...
  "OrderStatus": {
    "_enum": ["Created", "PartialFill", "Filled", "PartialFillAndCanceled", "Canceled"]
  },
  "AssetId": "u32",
  "MiningWeight": "u128",
  "VoteWeight": "u128",
  ...
  "WithdrawalState": {
    "_enum": ["Applying", "Processing", "NormalFinish", "RootFinish", "NormalCancel", "RootCancel"]
  },
  "WithdrawalRecord": {
    "assetId": "AssetId",
    "applicant": "AccountId",
  ...
  "BtcTxType": {
    "_enum": ["Withdrawal", "Deposit", "HotAndCold", "TrusteeTransition", "Irrelevance"]
  },
  "BtcDepositCache": {
    "txid": "H256",
    "balance": "u64"
